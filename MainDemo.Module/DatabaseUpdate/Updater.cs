...
namespace MainDemo.Module.DatabaseUpdate {
	public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
           ...
           ApplicationStatusUpdater.Notify("CreateAnalysis", "Creating analysis reports in the database...");
           CreateDataToBeAnalysed();
           ApplicationStatusUpdater.Notify("CreateSecurityData", "Creating users and roles in the database...");
